...
export function NotFoundEEIllustration(props: StyleRecordOnly<ComponentProps<'div'>>) {
    const { string } = useI18n()
    return (
        <VStack aria-hidden="true" {...props}>
            <img draggable="false" class={styles.image} src={NotFoundEEIcon} alt={string.IMG_ALT_NOT_FOUND()} />
        </VStack>
    )
}
