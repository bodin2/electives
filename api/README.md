...
| `ADMIN_ALLOWED_IPS`                                 | Comma-separated list of CIDR ranges allowed to access admin endpoints                          | `127.0.0.0/8, ::1/128`                                                                                                              |
| `ADMIN_PUBLIC_KEY`                                  | An X509 encoded RSA SSH public key used to authenticate admin users without PEM headers        | (None)<br>**Required if `ADMIN_ENABLED` is set.**                                                                                   |